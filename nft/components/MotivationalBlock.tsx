...
const stars = [
  {
    className:
      'absolute left-[-40%] top-[-30%] size-[55px] -rotate-12 sm:left-[-20%] sm:rotate-0 lg:left-[-2%]',
  },
  {
    className:
      'absolute left-[-100%] top-[30%] size-[75px] rotate-6 sm:left-[-40%] lg:left-[-12%]',
  },
  {
    className:
      'absolute left-[-60%] top-[100%] size-[65px] rotate-12 sm:left-[-30%] sm:top-[60%] sm:-rotate-[25deg] lg:left-[-4%]',
  },
  {
    className:
      'absolute right-[-60%] top-[-25%] size-[50px] rotate-6 sm:right-[-30%] sm:top-[0%] sm:size-[70px] sm:-rotate-12 lg:right-[-2%]',
  },
  {
    className:
      'absolute right-[-100%] top-[30%] size-[50px] rotate-6 sm:right-[-40%] lg:right-[-12%]',
  },
  {
    className:
      'absolute right-[-58%] top-[90%] size-[65px] -rotate-12 sm:right-[-30%] sm:top-[60%] sm:rotate-[25deg] lg:right-[-4%]',
  },
];
